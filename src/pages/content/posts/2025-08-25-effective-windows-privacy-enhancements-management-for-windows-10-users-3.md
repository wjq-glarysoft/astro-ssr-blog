...
Step 2: Modifying registry values For finer control, open the Registry Editor by pressing Windows + R, typing regedit, and pressing Enter. Navigate to: HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\Windows\\DataCollection Create a DWORD value named AllowTelemetry and set it to 0.
