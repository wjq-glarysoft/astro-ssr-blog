...
11\. Script Routine Tasks Write PowerShell scripts for repetitive tasks—installations, updates, audits, and removals. Example: To uninstall a program by name: Get-WmiObject -Query "SELECT \* FROM Win32_Product WHERE Name = 'ProgramName'" | ForEach-Object { $\_.Uninstall() }
