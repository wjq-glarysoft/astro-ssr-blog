...
5\. Reset System Configuration (msconfig) Beginners: If you’ve made startup or boot changes in msconfig, open the tool, select the "General" tab, and switch back to "Normal startup." Advanced: For advanced users, navigate to HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Shared Tools\\MSConfig in the Registry and remove stored configuration data.
