...
To check for leftover entries: 1. Press Windows + R, type “regedit,” and press Enter. 2. Navigate to HKEY_LOCAL_MACHINE\\Software or HKEY_CURRENT_USER\\Software. 3. Look for folders related to software you have uninstalled. If you find entries for old programs, right-click and delete them carefully.
