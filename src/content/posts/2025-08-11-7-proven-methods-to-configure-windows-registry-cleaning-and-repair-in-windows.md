...
1\. Press Windows + R, type regedit, and press Enter. 2. Navigate to HKEY_LOCAL_MACHINE\\SOFTWARE and find the program’s folder. 3. Right-click the folder and select Delete.
